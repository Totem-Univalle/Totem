...
function VentanaModal() {
  ...
  const [gifUrl, setGifUrl] = useState('https://media.tenor.com/a4SaQmo5EesAAAAj/iranserver-bluebot.gif');
  const [mensaje, setMensaje] = useState('Lo siento no encontramos resultados en su busqueda, Por favor intente nuevamente');
